 ...
 */
class FileSystem : public FileSystemLike, public KVStore {
public:
...
public:
    // FileSystem -> KVStore overrides. These may be overriden by
    // filesystems for more efficient implementations, although the default
    // implementations are likely sufficient.
