...
static void white_box_test()
{
    ...
    result = sec_kv->set(key1, key1_val1, strlen(key1_val1), KVStore::ENCRYPT_FLAG | KVStore::AUTHENTICATE_FLAG);
    TEST_ASSERT_EQUAL_ERROR_CODE(MBED_SUCCESS, result);

    result = sec_kv->set(key2, key2_val1, strlen(key2_val1), KVStore::AUTHENTICATE_FLAG);
    TEST_ASSERT_EQUAL_ERROR_CODE(MBED_SUCCESS, result);

    result = sec_kv->set(key2, key2_val2, strlen(key2_val2), KVStore::ENCRYPT_FLAG | KVStore::AUTHENTICATE_FLAG);
    TEST_ASSERT_EQUAL_ERROR_CODE(MBED_SUCCESS, result);
    ...
    timer.reset();
    result = sec_kv->set(key2, key2_val3, strlen(key2_val3), KVStore::AUTHENTICATE_FLAG | KVStore::ROLLBACK_PROTECT_FLAG);
    elapsed = timer.read_ms();
    ...
    result = sec_kv->set(key3, key3_val1, strlen(key3_val1),
                         KVStore::AUTHENTICATE_FLAG | KVStore::ENCRYPT_FLAG | KVStore::ROLLBACK_PROTECT_FLAG);
    TEST_ASSERT_EQUAL_ERROR_CODE(MBED_SUCCESS, result);

    result = sec_kv->set(key3, key3_val2, strlen(key3_val2),
                         KVStore::AUTHENTICATE_FLAG | KVStore::ENCRYPT_FLAG);
    ...
    for (int j = 0; j < 2; j++) {
        result = sec_kv->set(key4, key4_val1, strlen(key4_val1),
                             KVStore::AUTHENTICATE_FLAG | KVStore::ROLLBACK_PROTECT_FLAG);
        TEST_ASSERT_EQUAL_ERROR_CODE(MBED_SUCCESS, result);
    ...
    TEST_ASSERT_EQUAL_ERROR_CODE(MBED_SUCCESS, result);
    TEST_ASSERT_EQUAL(KVStore::AUTHENTICATE_FLAG | KVStore::ENCRYPT_FLAG | KVStore::ROLLBACK_PROTECT_FLAG, info.flags);
    ...
    result = sec_kv->set(key5, key5_val1, strlen(key5_val1),
                         KVStore::AUTHENTICATE_FLAG | KVStore::ROLLBACK_PROTECT_FLAG | KVStore::WRITE_ONCE_FLAG);
    TEST_ASSERT_EQUAL_ERROR_CODE(MBED_SUCCESS, result);
    ...
    result = ul_kv->set(key6, attack_buf, attack_size,
                        KVStore::AUTHENTICATE_FLAG | KVStore::ENCRYPT_FLAG | KVStore::ROLLBACK_PROTECT_FLAG);
    TEST_ASSERT_EQUAL_ERROR_CODE(MBED_SUCCESS, result);
    ...
    result = sec_kv->set(key7, key7_val1, strlen(key7_val1), KVStore::AUTHENTICATE_FLAG);
    TEST_ASSERT_EQUAL_ERROR_CODE(MBED_SUCCESS, result);
    ...
    result = sec_kv->set(key7, key7_val1, strlen(key7_val1), KVStore::AUTHENTICATE_FLAG | KVStore::ENCRYPT_FLAG);
    TEST_ASSERT_EQUAL_ERROR_CODE(MBED_SUCCESS, result);
    ...
    result = ul_kv->set_start(&handle, key7, attack_size, KVStore::AUTHENTICATE_FLAG | KVStore::ENCRYPT_FLAG);
    TEST_ASSERT_EQUAL_ERROR_CODE(MBED_SUCCESS, result);
