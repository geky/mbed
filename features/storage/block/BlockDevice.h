...
public:
     ...
     */
    virtual bd_count_or_error_t read(
            void *buffer, bd_block_t block, bd_count_t count = 1) = 0;
     ...
     */
    virtual bd_count_or_error_t write(
            const void *buffer, bd_block_t block, bd_count_t count = 1) = 0;
     ...
     */
    virtual bd_status_t get_status() = 0;
