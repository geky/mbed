...
protected:
    // Convenience function for checking block alignment
    static bool is_aligned(bd_addr_t x, bd_size_t alignment);

    // Convenience function for checking block validity
