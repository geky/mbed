...
nsapi_error_t NetworkStack::gethostbyname(const char *name, SocketAddress *address)
{
...
public:
    ...
    virtual nsapi_error_t gethostbyname(const char *name, SocketAddress *address)
    {
        ...
        nsapi_error_t err = _stack_api()->gethostbyname(_stack(), name, &addr, NSAPI_UNSPEC);
